...
**Use this stance when** the task is implementing or verifying changes in real code or technical systems — fixing bugs, adding features, targeted refactors, or strengthening tests.
